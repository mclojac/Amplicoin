...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x7549;// addresses start with "amp"
...
const char     CRYPTONOTE_NAME[]                             = "Amplicoin";
